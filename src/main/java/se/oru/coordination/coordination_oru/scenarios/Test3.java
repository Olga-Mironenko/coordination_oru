...
public class Test3 {
    public static void main(String[] args) {
        ...
        var lookAheadVehicle1 = new LookAheadVehicle(YAML_FILE, predictableDistance);
        ...
        var LPVPlan1 = lookAheadVehicle1.getPlan(mainTunnelLeft, limitedVehicleGoal, YAML_FILE, true);
        ...
        tec.setDefaultFootprint(lookAheadVehicle1.getFootPrint());
        ...
        tec.placeRobot(lookAheadVehicle1.getID(), mainTunnelLeft);
        ...
        tec.setForwardModel(lookAheadVehicle1.getID(), new ConstantAccelerationForwardModel(lookAheadVehicle1.getMaxAcceleration(), lookAheadVehicle1.getMaxVelocity(), tec.getTemporalResolution(),
                tec.getControlPeriod(), tec.getRobotTrackingPeriodInMillis(lookAheadVehicle1.getID())));
        ...
        var m4 = new Mission(lookAheadVehicle1.getID(), LPVPlan1);
