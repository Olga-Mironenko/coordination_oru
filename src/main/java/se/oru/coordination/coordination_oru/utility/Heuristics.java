...
public class Heuristics {
    ...
    public Comparator<RobotAtCriticalSection> lookAheadRobotsFirst() {
        ...
        return (o1, o2) -> {
            boolean isO1LookAhead = RobotHashMap.getRobot(o1.getRobotReport().getRobotID()).getClass().getSimpleName().equals("LookAheadRobot");
            boolean isO2LookAhead = RobotHashMap.getRobot(o2.getRobotReport().getRobotID()).getClass().getSimpleName().equals("LookAheadRobot");
