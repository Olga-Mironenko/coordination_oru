 ...
 * @author fpa
 */
public class CoordinatorDependency implements Comparable<CoordinatorDependency> {
    ...
    public CoordinatorDependency(TrajectoryEnvelope teWaiting, TrajectoryEnvelope teDriving, int waitingPoint, int thresholdPoint) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CoordinatorDependency)) return false;
        CoordinatorDependency other = (CoordinatorDependency) obj;
     ...
     * @PLEASE, BE SURE THE RIGHT FUNCTION WILL BE USED TO ADD OR REMOVE DEPENDENCIES FROM A SPECIFIC DATA STRUCTURE.
     */
    public int compareTo(CoordinatorDependency other) {
